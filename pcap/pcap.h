...
#define THREADERR -1
#define OUTFILEERR -2
#define INPUTFILEERR -3
#define ERROR_PCAP_PARSE_FAILED -4
#define ERROR_MEM_ALLOC_FAILED -5

typedef unsigned int  bpf_u_int32;
typedef unsigned short  u_short;
typedef int bpf_int32;

#define IPUDPLEN 0x2a  //wireshark抓包时，ip长度
//#define IPUDPLEN 0x20  //服务器抓包，ip长度,正式版本使用
/*
   Pcap文件头24B各字段说明：
